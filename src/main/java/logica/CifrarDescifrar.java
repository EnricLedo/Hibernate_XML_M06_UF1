...
public class CifrarDescifrar {
    ...
    * @throws IOException
    */
    public static void cifrar(String clau, String ruta) throws IOException
    {
        ...
        ExportarStringBuilder.exportar(juntarParts, ruta);
    }
    ...
    */
     ...
     */
    public static void descifrar(String clau, String ruta)
    {
        StringBuilder missatge = LeerXML.leerXml(ruta);
        ...
        ExportarStringBuilder.exportar(resultado, ruta);
    }
}
